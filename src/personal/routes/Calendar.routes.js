...
import { repo } from "../services/CalendarRepo.service.js";
import CalendarSchema from "../validations/Calendar.schema.js";

const calendarRouter = Router();

calendarRouter.post("/", auth, validate(CalendarSchema), async (req, res) => {
    try {
...
calendarRouter.get("/", auth, async (req, res) => {
    try {
...
calendarRouter.get(":/id", auth, async (req, res) => {
    try {
...
calendarRouter.put("/", auth, validate(CalendarSchema), async (req, res) => {
    try {
...
calendarRouter.delete("/:id", auth, async (req, res) => {
    try {
